...
return {
  ...
  dependencies = {
    ...
    -- fancy UI for the debugger
    {
      ...
      -- stylua: ignore
      keys = {
        { "<C-M-k>", function() require("dap").step_into() end, desc = "Dap Step Into" },
        { "<C-M-j>", function() require("dap").step_over() end, desc = "Dap Step Over" },
        { "M", function() require("dapui").eval() end, desc = "Dap Eval", mode = {"n", "v"} },
      },
      opts = {},
